    ...
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 bg-white">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wide">Particle Counts</h3>
            <p className="text-[10px] text-slate-400 uppercase tracking-widest mt-0.5">
              Model v{result.model_version || '—'}
            </p>
          </div>
          {overrideCount > 0 && (
            <span className="ml-2 inline-flex items-center rounded-full bg-amber-50 border border-amber-200 px-2.5 py-0.5 text-xs font-semibold text-amber-700">
